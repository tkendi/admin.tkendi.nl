...
import { MenuIconBox, MenuSection, MenuWrap, SubMenuSection, SubMenuWrap, TitleSection, Wrap } from './styles/index.style'

import { BodyText, CaptionText } from '@/components/atoms/Text'

const SideBarData = [
    { id: 1, title: "웹 사이트", isReady: true, link: "/web", subMenuList: [{ title: "인덱스 관리", isReady: true }, { title: "배너", isReady: false }] },
