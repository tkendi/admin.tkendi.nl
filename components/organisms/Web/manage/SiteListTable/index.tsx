        ...
        <SitListTable>
            <SiteListTableRow css={{ backgroundColor: "$BlueGray50" }}>
                ...
                <div style={{ width: '290px' }}>
                    <Body2 css={{ color: "$BlueGray600", fontWeight: 600 }}>검색 키워드</Body2>
                </div>
                <div style={{ width: '130px' }}>
                    <Body2 css={{ color: "$BlueGray600", fontWeight: 600 }}>등록일자</Body2>
                </div>
                <div style={{ width: '100px' }}>
                    <Body2 css={{ color: "$BlueGray600", fontWeight: 600 }}>상태</Body2>
                </div>
                <div style={{ width: '110px' }}>
                    <Body2 css={{ color: "$BlueGray600", fontWeight: 600 }}>미리보기</Body2>
                </div>
